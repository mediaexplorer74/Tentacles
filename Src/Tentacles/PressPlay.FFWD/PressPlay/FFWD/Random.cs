...
namespace PressPlay.FFWD
{
  public static class Random
  {
    ...
    public static PressPlay.FFWD.Vector3 insideUnitSphere
    {
      get
      {
        PressPlay.FFWD.Vector3 insideUnitSphere = new PressPlay.FFWD.Vector3(Random.Range(-1f, 1f), Random.Range(-1f, 1f), Random.Range(-1f, 1f));
    ...
    public static PressPlay.FFWD.Vector3 onUnitSphere => Random.insideUnitSphere.normalized;

    public static PressPlay.FFWD.Vector2 insideUnitCircle
    {
      get
      {
        PressPlay.FFWD.Vector2 insideUnitCircle = new PressPlay.FFWD.Vector2(Random.Range(-1f, 1f), Random.Range(-1f, 1f));
