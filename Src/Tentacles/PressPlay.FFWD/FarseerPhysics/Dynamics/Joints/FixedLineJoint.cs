...
// Type: FarseerPhysics.Dynamics.Joints.FixedLineJoint
...
namespace FarseerPhysics.Dynamics.Joints
{
  public class FixedLineJoint : Joint
  {
    ...
    internal FixedLineJoint() => this.JointType = JointType.FixedLine;

    public FixedLineJoint(Body body, Vector2 bodyAnchor, Vector2 worldAnchor, Vector2 axis)
      : base(body)
    {
      this.JointType = JointType.FixedLine;
      this.LocalAnchorA = body.GetLocalPoint(bodyAnchor);
      this.LocalAnchorB = body.GetLocalPoint(bodyAnchor);
      this.LocalXAxis = body.GetLocalVector(axis);
    }
