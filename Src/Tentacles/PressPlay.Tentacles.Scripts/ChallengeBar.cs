...
namespace PressPlay.Tentacles.Scripts
{
  public class ChallengeBar : MonoBehaviour
  {
    ...
    private Microsoft.Xna.Framework.Color nextColor;
    ...
    private void Initialize()
    {
      ...
      this.hiddenPosition = new PressPlay.FFWD.Vector3(8f, 10f, -150f);
      this.visiblePosition = new PressPlay.FFWD.Vector3(8f, 10f, -4f);
    ...
    public void Show(string text, Microsoft.Xna.Framework.Color color)
    {
      this.Initialize();
      if (!this.isVisible)
      {
    ...
    {
      iTween.ShakePosition(this.gameObject, iTween.Hash((object) "amount", (object) new PressPlay.FFWD.Vector3(2f, 2f, 0.0f), (object) "time", (object) 1));
    }
  }
}
