...
// Type: PressPlay.Tentacles.Scripts.AnimatedClawCollider
...
{
  public class AnimatedClawCollider : BasicClawCollider
  {
    ...
    internal override void DoOnHit(Claw _tip, Vector3 _hitDir)
    {
      this.anim.Stop();
