...
// Type: PressPlay.Tentacles.Scripts.AlertPopup
...
{
  public class AlertPopup : MenuSceneScreen
  {
    ...
    public AlertPopup(string message, Action cllback)
      : base("")
    {
    ...
    public override void LoadContent()
    {
      ...
      this.btnOK = new MenuButton(buttonStyle2, "ok");
      this.btnOK.textControl.font = GUIAssets.berlinsSans40;
      this.btnOK.textControl.text = LocalisationManager.Instance.GetString("btn_ok").ToUpper();
      this.btnOK.textControl.ignoreSize = true;
      this.btnOK.textControl.AlignCenter();
      this.btnOK.OnClickEvent += new EventHandler<EventArgs>(this.OnButtonPress);
      child.AddChild((Control) this.btnOK);
      child.LayoutRow();
      child.AlignCenter(new Rectangle(0, this.txtMessage.bounds.Height + 10, PressPlay.FFWD.ScreenManager.ScreenManager.Viewport.Width, PressPlay.FFWD.ScreenManager.ScreenManager.Viewport.Height));
