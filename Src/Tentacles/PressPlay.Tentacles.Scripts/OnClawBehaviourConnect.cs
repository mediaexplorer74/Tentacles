...
namespace PressPlay.Tentacles.Scripts
{
  public class OnClawBehaviourConnect : MonoBehaviour
  {
    ...
    public virtual void DoOnClawBehaviourConnect(ClawBehaviour _clawBehaviour, Microsoft.Xna.Framework.Vector3 _hitDir)
    {
    ...
    public delegate void DoOnConnectDelegate(ClawBehaviour _clawBehaviour, Microsoft.Xna.Framework.Vector3 _hitDir);
  }
}
