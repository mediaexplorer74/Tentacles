...
namespace PressPlay.Tentacles.Scripts
{
  public class BasicTentacleTipCollider : MonoBehaviour
  {
    ...
    protected void HitTip(TentacleTip _tip, Microsoft.Xna.Framework.Vector3 _hitDir)
    {
    ...
    protected virtual void DoOnHit(TentacleTip _tip, Microsoft.Xna.Framework.Vector3 _hitDir)
    {
    }

    protected virtual void DoOnStay(TentacleTip _tip, Microsoft.Xna.Framework.Vector3 _hitDir)
    {
    }

    internal void StayOnTip(TentacleTip _tip, Microsoft.Xna.Framework.Vector3 _hitDir) => this.DoOnStay(_tip, _hitDir);
    ...
    public delegate void DoOnHitDelegate(TentacleTip _tip, Microsoft.Xna.Framework.Vector3 _hitDir);
  }
}
